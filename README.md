...
| :--- | :--- | :--- |
| **Live Full-Stack App (Cloudflare Tunnel)** | [https://warrior-tours-discs-systematic.trycloudflare.com](https://warrior-tours-discs-systematic.trycloudflare.com) | Complete unified application (Frontend SPA + Spring Boot REST API + Live Database) |
